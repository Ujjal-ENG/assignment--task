    ...
    return (
        <div className="">
            ...
            <div className="flex justify-center">
                <div className="bg-[rgba(26, 28, 33, 0.40)] lg:backdrop-blur-md px-20 py-4 rounded shadow-xl w-full lg:max-w-2xl lg:flex justify-center items-center gap-10 lg:absolute bottom-20 mt-10 lg:mt-0">
                    <div className="mb-4">
